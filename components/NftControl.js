...
const itemCardList = [
  ...
  },
  {
    ...
    text:'Configure with any dedcentralixed echcanges'
  },
  {
    ...
    text:'deploy and manage mutiple collection'
  },
]
  ...
  return (
    <Box {...nftControlBoxStyle}>
      <Container {...nftControlContainerStyle}>
        <VStack>
          <Heading> Take full of the NFT space  </Heading>
          <Text> Built on multiple chains. NFT marketplace that are deployed, owned and owned by you </Text>
        </VStack>
        ...
        <Text {...typoStyle.text.nft} {...nftControlBigButton}> NFTs make the internet ownable because you can create digital scarcity were just <br /> scaratching the surfices of what the web 3.0 creator and collector economy is going to</Text>
      </Container>
    </Box>
  )
}
